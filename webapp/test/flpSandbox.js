		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Core for CBO GUI",
									"targetURL": "#coreforcbogui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"coreforcbogui-display": {
								"semanticObject": "coreforcbogui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=coreforcbogui",
									"url": sap.ui.require.toUrl("coreforcbogui")
								}
							}
						}
					}
